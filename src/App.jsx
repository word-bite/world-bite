...
import RelatoriosPlataforma from "./empresas/RelatoriosPlataforma";
  ...
  return (
    <Router>
      <Routes>
        ...
        {/* 📊 Rota para Relatórios da Plataforma (Público) */}
        <Route path="/relatorios-plataforma" element={<RelatoriosPlataforma />} />
